                ...
                <div class="offcanvas offcanvas-end" id="offcanvas">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item">
                                <form class="d-flex mb-3 position-relative" method="get" action="/search">
                            ...
                            ?>
                                ...
                                <li class="nav-item px-3">
                                    <a href="/user/<?= $_SESSION["user_id"] ?>" class="nav-link link-primary">Hồ sơ</a>
                                </li>
                                <li class="nav-item px-3">
                                    <a href="/logout" class="nav-link link-danger">Thoát</a>
                                </li>
                            <?php
                            } else {
                            ?>
                                <li class="nav-item ">
                                    <a class="nav-link px-2" href="/login">Đăng nhập</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link px-2" href="/register">Đăng kí</a>
                                </li>
                            <?php
                            }
                            ?>
